...
***
`완료` `알 수 없음`  
### BoB MMORPG 자신만의 퀘스트 플러그인 제작 - 전상현
...
### 실시간 공격과 대응 POC검증 - 김종민
  ...
  - 대응 전략 생각하기  
***
`완료` `2021년 02월 07일 일요일 까지`  
### 실시간 공격과 대응 POC검증 - 김종민
  - 공격 전략 생각하기  
  - 공격 모듈 실행파일 생성 및 정상 구동 테스트하기  
***
`대기` `2021년 02월 8일 월요일 까지`  
### Cloud Breach 중간 발표 - Niko, 정승기
  - 본인이 선택한 토픽과 시나리오에 대하여 매우 간략한 발표를 진행한다.  
